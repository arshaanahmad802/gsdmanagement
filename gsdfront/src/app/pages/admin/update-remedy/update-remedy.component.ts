...
@Component({
  selector: 'app-update-remedy',
  templateUrl: './update-remedy.component.html',
  styleUrls: ['./update-remedy.component.css']
})
export class UpdateRemedyComponent implements OnInit {
